def filter_by_label_type(points, desired_label):
    ...
    :restaurants: 地點列表，每個地點包含 place_id 和 label_type。 珣那包
...
if __name__ == "__main__":
    # 測試數據
    points = [
        {"place_id": 1, "new_label_type": "小吃"},
        {"place_id": 2, "new_label_type": "小吃"},
        {"place_id": 3, "new_label_type": "伴手禮商店"},
        {"place_id": 4, "new_label_type": "購物商場"},
        {"place_id": 5, "new_label_type": "小吃"},
        {"place_id": 6, "new_label_type": "自然景點"},
        {"place_id": 7, "new_label_type": "小吃"},
        {"place_id": 8, "new_label_type": "餐廳"}
    ]
    user_requirements = [
        {
            "星期別": 1,
    ...
    # 輸出結果
    print(f"符合 '{user_input}' 的地點 place_id:", place_id)
